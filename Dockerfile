...
###############################################################################
FROM registry.access.redhat.com/hi/python:3.14-builder@sha256:20608e2c6ac76e0f064ab7d5268ebfb70417a68a52a4c18a54b4140513faa8cf AS builder
...
# - multi-arch index ダイジェスト固定: amd64 / arm64 を同一参照で提供
###############################################################################
FROM registry.access.redhat.com/hi/nodejs:26-builder@sha256:6c64c042e6edcea45ff2d3dab0afa5a4f09ac7701015dc4b35155035a0c0fdca AS node-builder
...
###############################################################################
FROM registry.access.redhat.com/hi/nodejs:26@sha256:459a0724c0c93dfa0a9f820f0c227b8fe2742aa8beff4b45e1ca966570926d25 AS node-runtime
