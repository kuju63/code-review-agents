...
class TestGetTask:
    ...
    @pytest.mark.asyncio
    async def test_forwards_mcp_retry_settings(self) -> None:
        from code_review_agent.models.lead_engineer import LeadEngineerReport
        from code_review_agent.models.pr_info import (
            PRInfo,
            PRInfoResult,
