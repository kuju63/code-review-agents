 ...
 * docs/seeded-reviewer-stack-routing-spec.md section 4 for the follow-up.
 */
...
export class VueReviewer extends LLMReviewAgent {
  static readonly reviewerId = "vue-technical";
  static readonly perspective = ReviewPerspective.enum.TECHNICAL;
  static readonly projectTypes = new Set([ProjectType.enum.VUE]);
  protected readonly systemPrompt = SYSTEM_PROMPT;
  protected readonly skillType = AgentSkillType.VUE_REVIEW;
}

registerReviewer(VueReviewer);
